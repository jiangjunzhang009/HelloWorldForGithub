...
namespace InformationCollectionPlatform.Services
{
    ...
    public sealed partial class SqlHelper
    {
        ...
        #region methods for MKO(strategy summit) FaceGrouping Meeting Game
        //public int ExecProc_CreateImageAndImageFace(string faceIds, string bigImgblobUri, string faceRectangles)
        //{
        //    int result = -2;
        //    try
        //    {
        ...
        //            cmd.CommandText = "[dbo].[pro_CreateImageAndImageFace]";
        //            cmd.Parameters.Add("@sys_bigImageBlobUri", SqlDbType.VarChar, 512);
        //            cmd.Parameters.Add("@sys_faceIds", SqlDbType.VarChar, 3000);
        //            cmd.Parameters.Add("@sys_faceRectangles", SqlDbType.VarChar, 6000);
        //            cmd.Parameters.Add("@status", SqlDbType.Int);
        //            cmd.Parameters["@sys_bigImageBlobUri"].Value = bigImgblobUri;
        //            cmd.Parameters["@sys_faceIds"].Value = faceIds;
        //            cmd.Parameters["@sys_faceRectangles"].Value = faceRectangles;
        //            cmd.Parameters["@status"].Direction = ParameterDirection.Output;
        //            cmd.ExecuteNonQuery();
        //            if (null != cmd.Parameters["@status"].Value)
        //            {
        ...
        //    return result;
        //}
        //public int ExecProc_CreateGroupFaceRecords(string faceIds, string groupCounts)
        //{
        //    int result = -2;
        //    try
        //    {
        ...
        //            cmd.Connection = conn;
        //            cmd.CommandType = CommandType.StoredProcedure;
        //            cmd.CommandText = "[dbo].[pro_CreateGroupFaceRecords]";
        //            cmd.Parameters.Add("@sys_faceIds", SqlDbType.VarChar, 8000);
        //            cmd.Parameters.Add("@sys_groupCounts", SqlDbType.VarChar, 2000);
        //            cmd.Parameters.Add("@status", SqlDbType.Int);
        //            cmd.Parameters["@sys_faceIds"].Value = faceIds;
        //            cmd.Parameters["@sys_groupCounts"].Value = groupCounts;
        //            cmd.Parameters["@status"].Direction = ParameterDirection.Output;
        //            cmd.ExecuteNonQuery();
        //            if (null != cmd.Parameters["@status"].Value)
        //            {
        ...
        //    return result;
        //}
        //public int ExecProc_UpdateGroupFaceRecords(string faceIds, string groupCounts)
        //{
        //    int result = -2;
        //    try
        //    {
        ...
        //            cmd.Connection = conn;
        //            cmd.CommandType = CommandType.StoredProcedure;
        //            cmd.CommandText = "[dbo].[pro_UpdateGroupFaceRecords]";
        //            cmd.Parameters.Add("@sys_faceIds", SqlDbType.VarChar, 8000);
        //            cmd.Parameters.Add("@sys_groupCounts", SqlDbType.VarChar, 2000);
        //            cmd.Parameters.Add("@status", SqlDbType.Int);
        //            cmd.Parameters["@sys_faceIds"].Value = faceIds;
        ...
        //    return result;
        //}
        //public int ExecProc_updateLastHandledFaceIdID(string faceId)
        //{
        //    int result = -2;
        //    try
        //    {
        ...
        //            cmd.Connection = conn;
        //            cmd.CommandType = CommandType.StoredProcedure;
        //            cmd.CommandText = "[dbo].[pro_updateLastHandledFaceIdID]";
        //            cmd.Parameters.Add("@sys_lastHandledFaceId", SqlDbType.VarChar, 8000);
        //            cmd.Parameters.Add("@status", SqlDbType.Int);
        //            cmd.Parameters["@sys_lastHandledFaceId"].Value = faceId;
        //            cmd.Parameters["@status"].Direction = ParameterDirection.Output;
        //            cmd.ExecuteNonQuery();
        //            if (null != cmd.Parameters["@status"].Value)
        //            {
        ...
        //public int ExecProc_CreateOnlyImageFace(string faceIds, string bigImgblobUri, string faceRectangles)
        //{
        //    int result = -2;
        //    try
        //    {
        ...
        //            cmd.Connection = conn;
        //            cmd.CommandType = CommandType.StoredProcedure;
        //            cmd.CommandText = "[dbo].[pro_CreateOnlyImageFace]";
        //            cmd.Parameters.Add("@sys_bigImageBlobUri", SqlDbType.VarChar, 512);
        //            cmd.Parameters.Add("@sys_faceIds", SqlDbType.VarChar, 3000);
        //            cmd.Parameters.Add("@sys_faceRectangles", SqlDbType.VarChar, 6000);
        //            cmd.Parameters.Add("@status", SqlDbType.Int);
        ...
        //    return result;
        //}
        //public int ExecProc_AddOrUpdateGroupedPeopleRelationship(string groupFaceIdsLink, string groupPhotoNumber)
        //{
        //    int result = -2;
        //    try
        //    {
        ...
        //            cmd.Connection = conn;
        //            cmd.CommandType = CommandType.StoredProcedure;
        //            cmd.CommandText = "[dbo].[pro_AddOrUpdateGroupedPeopleRelationShip]";
        //            cmd.Parameters.Add("@sys_groupFaceIdentityIdLinks", SqlDbType.VarChar, 4000);
        //            cmd.Parameters.Add("@sys_groupPhotoNumber", SqlDbType.VarChar, 1000);
        //            cmd.Parameters.Add("@status", SqlDbType.Int);
        //            cmd.Parameters["@sys_groupFaceIdentityIdLinks"].Value = groupFaceIdsLink;
        //            cmd.Parameters["@sys_groupPhotoNumber"].Value = groupPhotoNumber;
        //            cmd.Parameters["@status"].Direction = ParameterDirection.Output;
        //            cmd.ExecuteNonQuery();
        //            if (null != cmd.Parameters["@status"].Value)
        //            {
        ...
        //public int ExecProc_CreatePublicUserAndBatchUserLink(Table_PublicUser user)
        //{
        //    int result = -2;
        //    try
        //    {
        ...
        //            cmd.Connection = conn;
        //            cmd.CommandType = CommandType.StoredProcedure;
        //            cmd.CommandText = "[dbo].[pro_CreatePublicUserAndBatchUserLink]";
        //            cmd.Parameters.Add("@sys_batchId", SqlDbType.Int);
        //            cmd.Parameters.Add("@sys_name", SqlDbType.NVarChar, 20);
        //            cmd.Parameters.Add("@sys_gender", SqlDbType.NVarChar, 10);
        //            cmd.Parameters.Add("@sys_department", SqlDbType.Int);
        //            cmd.Parameters.Add("@sys_departmentType", SqlDbType.NVarChar, 20);
        //            cmd.Parameters.Add("@sys_positionRank", SqlDbType.NVarChar, 20);
        //            //cmd.Parameters.Add("@sys_lengthofService", SqlDbType.NVarChar, 20);
        //            cmd.Parameters.Add("@sys_age", SqlDbType.Int);
        //            cmd.Parameters.Add("@sys_ageRange", SqlDbType.NVarChar, 20);
        //            cmd.Parameters.Add("@sys_nativePlace", SqlDbType.Int);
        //            //cmd.Parameters.Add("@sys_onboardDate", SqlDbType.NVarChar, 20);
        //            //cmd.Parameters.Add("@sys_projectTeamProperty", SqlDbType.NVarChar, 20);
        //            cmd.Parameters.Add("@sys_constellation", SqlDbType.Int);
        //            cmd.Parameters.Add("@sys_standardHobby", SqlDbType.VarChar, 50);
        //            cmd.Parameters.Add("@sys_customHobby", SqlDbType.NVarChar, 50);
        //            cmd.Parameters.Add("@sys_knowBigData", SqlDbType.NVarChar, 5);
        //            cmd.Parameters.Add("@sys_noCashPayments", SqlDbType.NVarChar, 5);
        //            cmd.Parameters.Add("@publicUserId", SqlDbType.Int);
        //            cmd.Parameters["@sys_batchId"].Value = user.existsBatchId;
        //            cmd.Parameters["@sys_name"].Value = user.name;
        //            cmd.Parameters["@sys_gender"].Value = user.gender;
        //            cmd.Parameters["@sys_department"].Value = user.department;
        //            cmd.Parameters["@sys_departmentType"].Value = user.departmentType;
        //            cmd.Parameters["@sys_positionRank"].Value = user.positionRank;
        //            //cmd.Parameters["@sys_lengthofService"].Value = user.lengthofService;
        //            cmd.Parameters["@sys_age"].Value = user.age;
        //            cmd.Parameters["@sys_ageRange"].Value = user.ageRange;
        //            cmd.Parameters["@sys_nativePlace"].Value = user.nativePlace;
        //            //cmd.Parameters["@sys_onboardDate"].Value = user.onboardDate;
        //            //cmd.Parameters["@sys_projectTeamProperty"].Value = user.projectTeamProperty;
        //            cmd.Parameters["@sys_constellation"].Value = user.constellation;
        //            cmd.Parameters["@sys_standardHobby"].Value = user.standardHobby;
        //            cmd.Parameters["@sys_customHobby"].Value = user.customHobby;
        //            cmd.Parameters["@sys_knowBigData"].Value = user.knowAboutBigDataPractice;
        //            cmd.Parameters["@sys_noCashPayments"].Value = user.frequencyofNonCashPayments;
        //            cmd.Parameters["@publicUserId"].Direction = ParameterDirection.Output;
        //            cmd.ExecuteNonQuery();
        //            if (null != cmd.Parameters["@publicUserId"].Value)
        //            {
        //                result = (int)cmd.Parameters["@publicUserId"].Value;
        //            }
        //        }
        //    }
        //    catch (Exception ex)
        ...
        //    return result;
        //}
        //public string[] ExecProc_GetQuestionnaireTwoSumScoreByBatchId(int batchId)
        //{
        //    string[] result = null;
        //    try
        //    {
        //        string strSixSumScore = string.Empty;
        //        using (SqlConnection conn = new SqlConnection(ConnectionString))
        //        {
        //            conn.Open();
        //            SqlCommand cmd = new SqlCommand();
        //            cmd.Connection = conn;
        //            cmd.CommandType = CommandType.StoredProcedure;
        //            cmd.CommandText = "[dbo].[pro_GetQuestionnaireTwoSumScoreByBatchId]";
        //            cmd.Parameters.Add("@sys_batchId", SqlDbType.Int);
        //            cmd.Parameters.Add("@sixSumScores", SqlDbType.VarChar, 50);
        //            cmd.Parameters["@sys_batchId"].Value = batchId;
        //            cmd.Parameters["@sixSumScores"].Direction = ParameterDirection.Output;
        //            cmd.ExecuteNonQuery();
        //            if (null != cmd.Parameters["@sixSumScores"].Value)
        //            {
        //                strSixSumScore = cmd.Parameters["@sixSumScores"].Value.ToString();
        //            }
        //        }
        //        if (!string.IsNullOrWhiteSpace(strSixSumScore))
        //        {
        //            result = strSixSumScore.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //public string[] ExecProc_GetQuestionnaireThreeAvgScoreByBatchId(int batchId)
        //{
        //    string[] result = null;
        //    try
        //    {
        //        string strThirteenAvgScore = string.Empty;
        //        using (SqlConnection conn = new SqlConnection(ConnectionString))
        //        {
        //            conn.Open();
        //            SqlCommand cmd = new SqlCommand();
        //            cmd.Connection = conn;
        //            cmd.CommandType = CommandType.StoredProcedure;
        //            cmd.CommandText = "[dbo].[pro_GetQuestionnaireThreeAvgScoreByBatchId]";
        //            cmd.Parameters.Add("@sys_batchId", SqlDbType.Int);
        //            cmd.Parameters.Add("@elevenAvgScores", SqlDbType.VarChar, 100);
        //            cmd.Parameters["@sys_batchId"].Value = batchId;
        //            cmd.Parameters["@elevenAvgScores"].Direction = ParameterDirection.Output;
        //            cmd.ExecuteNonQuery();
        //            if (null != cmd.Parameters["@elevenAvgScores"].Value)
        //            {
        //                strThirteenAvgScore = cmd.Parameters["@elevenAvgScores"].Value.ToString();
        //            }
        //        }
        //        if (!string.IsNullOrWhiteSpace(strThirteenAvgScore))
        //        {
        //            result = strThirteenAvgScore.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
